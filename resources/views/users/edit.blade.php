<x-layouts.app :title="__('User')">
    ...
    <div class="mt-6 w-full">
        ...
        <flux:fieldset>
            <flux:input label="Name" name="name" value="{{ old('name', $user->name) }}" class="max-w-sm" />
            <flux:input label="Email" name="email" type="email" value="{{ old('email', $user->email) }}" class="max-w-sm" />
            ...
            <flux:text class="mt-2 mb-6">Leave empty if you don't want to change the password</flux:text>
        </flux:fieldset>
